          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            {authStep === 'credentials' ? (
              ...
              <div className="space-y-4 animate-slide-in">
                <div className="bg-primary-50 p-4 rounded-md border border-primary-100 mb-4">
                  <p className="text-sm font-medium text-primary-800 text-center">
                    Enhanced Security Check
                  </p>
                  <p className="text-xs text-primary-600 text-center mt-1">
                    Please enter the 4-digit mock OTP code sent to your configured device.
                  </p>
                </div>
                <Input
                ...
                <button
                  ...
                  className="block mx-auto text-xs text-gray-500 hover:text-gray-700 underline mt-2"
                >
                  Go Back
                </button>
              </div>
            ...
            >
              {authStep === 'credentials' ? 'Continue securely' : 'Verify & Sign in'}
            </Button>
          </form>
